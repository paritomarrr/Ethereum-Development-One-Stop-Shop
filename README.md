...
# Ethereum Development One-Stop Shop (This is a modified version of Consensys' Ethereum dev Tool Kit)
It is a comprehensive resource for Ethereum developers, providing a centralized repository of tools, guides, and information needed to build on the Ethereum platform. 

From contract development and deployment to dApp building and scaling, this GitHub repository offers a convenient and streamlined development experience.


## Table of Contents
- [Ethereum Development One-Stop Shop](#ethereum-development-One-Stop-Shop)
  - [Table of Contents](#table-of-contents)
  - [New developers start here](#new-developers-start-here)
  - [Platforms to learn web3 development from scratch](#Platforms-to-learn-web3-development-from-scratch)
...
## Platforms to learn web3 development from scratch

- [Alchemy University](https://university.alchemy.com/) - High-quality tutorials with an active discord server
- [Buildspace](https://buildspace.so/) - Multiple dApp tutorials from scratch
- [LearnWeb3 DAO](https://learnweb3.io/) - Divided the course into 4 levels based on the difficulty
